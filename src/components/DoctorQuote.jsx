...
const DoctorQuote = ({ text, author }) => {
  return (
    <div className="relative mt-8 max-w-xl mx-auto p-6 rounded-2xl shadow-3xl bg-yellow-100 backdrop-blur-md border border-teal-100 hover:shadow-xl transition-all duration-300 ">
